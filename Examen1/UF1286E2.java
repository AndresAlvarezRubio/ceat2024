...
//        selectMenu = sc.nextByte();
  ...
  public static void switchUserMain() {
      ...
      do {
          ...
          //UI
          /**Variables dadas a uiProducts() post examen*/
          uiProducts(numBotella, numGarPeq, numGarGra);
  ...
  public static void uiProducts(int numBotella, int numGarPeq, int numGarGra) {
    ...
    /**Post Examen*/
    System.out.println("██");
    System.out.println("██  Total = " + ((9.99*numBotella) + (29.99*numGarPeq) + (49.99*numGarGra)) + "€    ");
